const Projects = () => {
  return (
    <section className="relative flex justify-center items-center h-screen bg-[url('/creation.jpg')] bg-no-repeat bg-center bg-cover">
      ...
      <div className="flex flex-col items-center justify-center bg-black/40 backdrop-blur-lg h-screen w-full">
